...
In R, there are several ways to create visualizations (e.g., ggblend, ggnewscale, and gganimate), ggplot2 is one of the most widely used and influential approaches ([Cook book 2nd Edition](https://rc2e.com/inputandoutput#recipe-readexcel)). When creating figures for academic papers using ggplot2, it is important to pay attention to the figure size. In many scientific journals:
